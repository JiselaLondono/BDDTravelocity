...
public class UtilidadesCSV {
  ...
  private static final String PREFIJO_NOMBRE_DATOS_CSV = "data_";
  ...
  private static List<Map<String, String>> obtenerDatosFiltrados(
    ...
    String[] arrListadoFiltros = cadenaListadoFiltros.split(",");
  ...
  private static List<Map<String, String>> filtrarDatos(
    ...
    return listaTotalDatos
        .stream()
        .filter(fila -> inArray(arrListaFiltros, fila.get(NOMBRE_COLUMNA_FILTRO)))
  ...
  /*public static String obtenerDatoContenidoCSV(
          EnumNombresCsv nomDiccionarioCSV,
